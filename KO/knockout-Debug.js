    ...
    (function (factory) {
      ...
      ko.utils = (function () {
        ...
        return {
          ...
          registerEventHandler: function (element, eventType, handler) {
            ...
            if (
              ...
              if (!jQueryEventAttachName) {
                jQueryEventAttachName =
                  typeof jQueryInstance(element)["on"] == "function"
                    ? "on"
                    : "bind";
              }
              jQueryInstance(element)[jQueryEventAttachName](
                eventType,
                wrappedHandler
              );
            } else if (
          ...
          setElementName: function (element, name) {
            ...
            if (ieVersion <= 7) {
              try {
                var escapedName = element.name.replace(
                  /[&<>'"]/g,
                  function (r) {
                ...
                element.mergeAttributes(
                  document.createElement("<input name='" + escapedName + "'/>"),
                  false
                );
      ...
      ko.utils.domData = new (function () {
        ...
        return {
          ...
          set: function (node, key, value) {
            ...
            var dataForNode = getDataForNode(
              node,
              value !== undefined /* createIfNotFound */
            );
        ...
        function cleanNodesInList(nodeList, onlyComments) {
          ...
          for (var i = 0; i < nodeList.length; i++) {
            if (!onlyComments || nodeList[i].nodeType === 8) {
              cleanSingleNode(
                (cleanedNodes[cleanedNodes.length] = lastCleanedNode =
                  nodeList[i])
              );
              if (nodeList[i] !== lastCleanedNode) {
                while (
                  i-- &&
                  ko.utils.arrayIndexOf(cleanedNodes, nodeList[i]) == -1
                ) {}
              }
            }
          }
      ...
      (function () {
        ...
        ko.utils.parseHtmlForTemplateNodes = function (html, documentContext) {
          ...
          return (
            (nodes.length && nodes[0].parentElement) ||
            ko.utils.moveCleanedNodesToContainerElement(nodes)
          );
        };
      ...
      ko.subscription.prototype.disposeWhenNodeIsRemoved = function (node) {
        ...
        ko.utils.domNodeDisposal.addDisposeCallback(
          node,
          (this._domNodeDisposalCallback = this.dispose.bind(this))
        );
      };
      ...
      ko.exportSymbol(
        "computedContext.getDependencies",
        ko.computedContext.getDependencies
      );
      ko.exportSymbol(
      ...
      ko.exportSymbol(
        "computedContext.registerDependency",
        ko.computedContext.registerDependency
      );
      ...
      ko.isObservable = function (instance) {
        ...
        if (
          proto &&
          proto !== observableFn[protoProperty] &&
          proto !== ko.computed["fn"][protoProperty]
        ) {
          throw Error(
      ...
      ko.isWriteableObservable = function (instance) {
        return (
          ...
          (instance[protoProperty] === observableFn[protoProperty] || // Observable
            (instance[protoProperty] === ko.computed["fn"][protoProperty] &&
      ...
      ko.extenders["trackArrayChanges"] = function (target, options) {
        ...
        function trackChanges() {
          ...
          spectateSubscription = target.subscribe(
            function () {
              ++pendingChanges;
            },
            null,
      ...
      var computedFn = {
        ...
        evaluateImmediate_CallReadWithDependencyDetection: function (
          ...
          if (!state.dependenciesCount) {
            ...
            changed = computedObservable.isDifferent(
              state.latestValue,
              newValue
            );
          }
      ...
      ko.isComputed = function (instance) {
        return (
          typeof instance == "function" &&
          instance[protoProp] === computedFn[protoProp]
        );
      };
      ...
      ko.when = function (predicate, callback, context) {
        function kowhen(resolve) {
          var observable = ko
            .pureComputed(predicate, context)
          ...
          function processKeyValue(key, val) {
            ...
            if (!bindingParams) {
              ...
              if (
                ...
                var writeKey =
                  typeof twoWayBindings[key] == "string"
                    ? twoWayBindings[key]
                    : key;
                propertyAccessorResultStrings.push(
                  "'" + writeKey + "':function(_z){" + writableVal + "=_z}"
                );
              }
            }
      ...
      (function () {
        ...
        function isUnmatchedEndComment(node) {
          return (
            isEndComment(node) &&
            !ko.utils.domData.get(node, matchedEndCommentDataKey)
          );
        }
          ...
          firstChild: function (node) {
            if (!isStartComment(node)) {
              if (node.firstChild && isEndComment(node.firstChild)) {
                throw new Error(
                  "Found invalid end comment, as the first child of " + node
                );
              }
      ...
      (function () {
        ...
        var contextSubscribable =
          ko.utils.createSymbolOrString("_subscribable");
        var contextAncestorBindingInfo = ko.utils.createSymbolOrString(
          "_ancestorBindingInfo"
        );
        var contextDataDependency =
          ko.utils.createSymbolOrString("_dataDependency");
        ...
        ko.bindingContext = function (
          ...
          function updateContext() {
            ...
            if (parentContext) {
              ...
              if (contextAncestorBindingInfo in parentContext) {
                self[contextAncestorBindingInfo] =
            ...
            if (
              ...
              !ko.computedContext
                .computed()
                .hasAncestorDependency(parentContext[contextSubscribable])
            ) {
              parentContext[contextSubscribable]();
            }
          ...
          var self = this,
            ...
            realDataItemOrAccessor = shouldInheritData
              ? undefined
              : dataItemOrAccessor,
            isFunc =
        ...
        AsyncCompleteContext.prototype.notifyAncestor = function () {
          if (
            this.ancestorBindingInfo &&
            this.ancestorBindingInfo.asyncContext
          ) {
        ...
        AsyncCompleteContext.prototype.completeChildren = function () {
          ...
          if (this.bindingInfo.asyncContext && !this.asyncDescendants.length) {
            ...
            ko.bindingEvent.notify(
              this.node,
              ko.bindingEvent.descendantsComplete
            );
            this.notifyAncestor();
          }
        };
        ...
        ko.bindingEvent = {
          ...
          subscribe: function (node, event, callback, context, options) {
            var bindingInfo = ko.utils.domData.getOrSet(
              node,
            ...
            if (
              options &&
              options["notifyImmediately"] &&
              bindingInfo.notifiedEvents[event]
            ) {
              ko.dependencyDetection.ignore(callback, context, [node]);
            }
            return bindingInfo.eventSubscribable.subscribe(
              callback,
              context,
              event
            );
          ...
          notify: function (node, event) {
            var bindingInfo = ko.utils.domData.get(
              node,
              boundElementDomDataKey
            );
            if (bindingInfo) {
              ...
              if (event == ko.bindingEvent.childrenComplete) {
                if (bindingInfo.asyncContext) {
                  ...
                  bindingInfo.eventSubscribable &&
                  bindingInfo.eventSubscribable.hasSubscriptionsForEvent(
                    ko.bindingEvent.descendantsComplete
                  )
                ) {
          ...
          startPossiblyAsyncContentBinding: function (node, bindingContext) {
            ...
            if (!bindingInfo.asyncContext) {
              bindingInfo.asyncContext = new AsyncCompleteContext(
                node,
                bindingInfo,
                bindingContext[contextAncestorBindingInfo]
              );
            }
        ...
        function applyBindingsToDescendantsInternal(
          ...
          var nextInQueue = ko.virtualElements.firstChild(
            elementOrVirtualElement
          );
          ...
          ko.bindingEvent.notify(
            elementOrVirtualElement,
            ko.bindingEvent.childrenComplete
          );
        }
        ...
        function applyBindingsToNodeAndDescendantsInternal(
          ...
          if (shouldApplyBindings)
            bindingContextForDescendants = applyBindingsToNodeInternal(
              nodeVerified,
              null,
              bindingContext
            )["bindingContextForDescendants"];
        ...
        function applyBindingsToNodeInternal(
          ...
          if (bindings) {
            ...
            if (ko.bindingEvent.childrenComplete in bindings) {
              ko.bindingEvent.subscribe(
                ...
                ko.bindingEvent.childrenComplete,
                function () {
                  var callback = evaluateValueAccessor(
                    bindings[ko.bindingEvent.childrenComplete]
                  );
                  if (callback) {
            ...
            if (ko.bindingEvent.descendantsComplete in bindings) {
              contextToExtend =
                ko.bindingEvent.startPossiblyAsyncContentBinding(
                  node,
                  bindingContext
                );
              ko.bindingEvent.subscribe(
                ...
                function () {
                  var callback = evaluateValueAccessor(
                    bindings[ko.bindingEvent.descendantsComplete]
                  );
          ...
          var shouldBindDescendants =
            bindingHandlerThatControlsDescendantBindings === undefined;
          return {
            shouldBindDescendants: shouldBindDescendants,
            bindingContextForDescendants:
              shouldBindDescendants && contextToExtend,
          };
        }
                ...
                ko.components.get(
                  ...
                  function (componentDefinition) {
                    ...
                    var componentViewModel = createViewModel(
                      ...
                      childBindingContext = asyncContext["createChildContext"](
                        componentViewModel,
                        {
                          extend: function (ctx) {
                    ...
                    if (
                      ...
                      afterRenderSub = ko.bindingEvent.subscribe(
                        element,
                        ko.bindingEvent.descendantsComplete,
                        componentViewModel["koDescendantsComplete"],
                        componentViewModel
      ...
      ko.bindingHandlers["attr"] = {
        update: function (element, valueAccessor, allBindings) {
          ...
          ko.utils.objectForEach(value, function (attrName, attrValue) {
            ...
            var namespace =
              "lookupNamespaceURI" in element &&
              prefixLen > 0 &&
              element.lookupNamespaceURI(attrName.substr(0, prefixLen));
        ...
        ko.bindingHandlers["checked"] = {
          ...
          init: function (element, valueAccessor, allBindings) {
            ...
            function updateModel() {
              ...
              if (
                !isChecked &&
                (isRadio || ko.computedContext.getDependenciesCount())
              ) {
                return;
              }
            ...
            function updateView() {
              ...
              if (valueIsArray) {
                ...
                element.checked =
                  ko.utils.arrayIndexOf(modelValue, elemValue) >= 0;
                oldElemValue = elemValue;
        ...
        function makeWithIfBinding(bindingKey, isWith, isNot) {
          ko.bindingHandlers[bindingKey] = {
            init: function (
              ...
              needAsyncContext =
                completeOnRender ||
                allBindings["has"](ko.bindingEvent.descendantsComplete);
                ...
                function () {
                  ...
                  if (shouldDisplay) {
                    if (!isWith || renderOnEveryChange) {
                      contextOptions["dataDependency"] =
                        ko.computedContext.computed();
                    }
        ...
        update: function (element, valueAccessor) {
          ...
          ko.utils.objectForEach(value, function (styleName, styleValue) {
            ...
            if (jQueryInstance) {
              ...
              if (
                styleValue !== previousStyle &&
                element.style[styleName] == previousStyle &&
                !isNaN(styleValue)
              ) {
      ...
      (function () {
        if (window && window.navigator) {
          ...
          (operaVersion =
            ...
            (chromeVersion = parseVersion(
              userAgent.match(/Chrome\/([^ ]+)/)
            )) ||
            (safariVersion = parseVersion(
              userAgent.match(/Version\/([^ ]+) Safari/)
            )) ||
            ...
            (ieVersion =
              ko.utils.ieVersion ||
              parseVersion(userAgent.match(/MSIE ([^ ]+)/))) || // Detects up to IE 10
        ...
        init: function (element, valueAccessor, allBindings) {
          ...
          if (requestedEventsToCatch) {
            ...
            if (typeof requestedEventsToCatch == "string") {
              ...
              eventsToCatch = ko.utils.arrayGetDistinctValues(
            ...
            if (arguments.length == 0) {
              ...
              if (!nodes || templateData.alwaysCheckText) {
                ...
                if (text && text !== templateData.textData) {
                  nodes = ko.utils.parseHtmlForTemplateNodes(
                    text,
      ...
      (function () {
          ...
          if (haveAddedNodesToParent) {
            ...
            if (options["afterRender"]) {
              ko.dependencyDetection.ignore(options["afterRender"], null, [
                renderedNodesArray,
                bindingContext[options["as"] || "$data"],
              ]);
            }
        ...
        ko.renderTemplateForEach = function (
          ...
          var setDomNodeChildrenFromArrayMapping = function (
            newArray,
            changeList
          ) {
          ...
          var shouldHideDestroyed =
            options["includeDestroyed"] === false ||
            (ko.options["foreachHidesDestroyed"] &&
              !options["includeDestroyed"]);

          if (
            !shouldHideDestroyed &&
            !options["beforeRemove"] &&
            ko.isObservableArray(arrayOrObservableArray)
          ) {
            ...
            return ko.dependentObservable(
              function () {
                ...
                if (shouldHideDestroyed) {
                  // Filter out any entries marked as destroyed
                  unwrappedArray = ko.utils.arrayFilter(
                    unwrappedArray,
                    function (item) {
                      return (
                        item === undefined ||
        ...
        function disposeOldComputedAndStoreNewOne(element, newComputed) {
          ...
          ko.utils.domData.set(
            element,
            templateComputedDomDataKey,
            newComputed && (!newComputed.isActive || newComputed.isActive())
              ? newComputed
              : undefined
          );
        }
        ...
        ko.bindingHandlers["template"] = {
          init: function (element, valueAccessor) {
            ...
            if (typeof bindingValue == "string" || "name" in bindingValue) {
              ...
              if (
                !container ||
                !ko.utils.domData.get(container, cleanContainerDomDataKey)
              ) {
          ...
          for (smlIndex = 0; smlIndex <= smlIndexMax; smlIndex++) {
            ...
            for (
              ...
              if (!bigIndex) thisRow[bigIndex] = smlIndex + 1;
                ...
                thisRow[bigIndex] =
                  lastRow[bigIndex - 1]; // copy value (no edit)
              else {
      ...
      (function () {
        ...
        ko.utils.setDomNodeChildrenFromArrayMapping = function (
          ...
          options = options || {};
          var lastMappingResult = ko.utils.domData.get(
            domNode,
          ...
          if (isFirstExecution) {
            ...
            if (
              !editScript ||
              (lastMappingResult && lastMappingResult["_countWaitingForRemove"])
            ) {
            ...
            for (
              var i = 0, editScriptItem, movedIndex, itemIndex;
          ...
          if (itemsToMoveFirstIndexes.length) {
            while ((i = itemsToMoveFirstIndexes.shift()) != undefined) {
              ...
              for (
                j = 0;
                (nodeToInsert = mapData.mappedNodes[j]);
                lastNode = nodeToInsert, j++
              ) {
          ...
          if (
            activeElement &&
            domNode.ownerDocument.activeElement != activeElement
          ) {
            activeElement.focus();
          }
